...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\AdministrateurType' => ['privates', 'App\\Form\\AdministrateurType', 'getAdministrateurTypeService', true],
            'App\\Form\\BiomeType' => ['privates', 'App\\Form\\BiomeType', 'getBiomeTypeService', true],
            'App\\Form\\ChambreType' => ['privates', 'App\\Form\\ChambreType', 'getChambreTypeService', true],
            'App\\Form\\ClientRegistrationFormType' => ['privates', 'App\\Form\\ClientRegistrationFormType', 'getClientRegistrationFormTypeService', true],
            'App\\Form\\ClientType' => ['privates', 'App\\Form\\ClientType', 'getClientTypeService', true],
            'App\\Form\\DinosaureType' => ['privates', 'App\\Form\\DinosaureType', 'getDinosaureTypeService', true],
            'App\\Form\\EnclosType' => ['privates', 'App\\Form\\EnclosType', 'getEnclosTypeService', true],
            'App\\Form\\FormatBilletType' => ['privates', 'App\\Form\\FormatBilletType', 'getFormatBilletTypeService', true],
            'App\\Form\\FormatChambreType' => ['privates', 'App\\Form\\FormatChambreType', 'getFormatChambreTypeService', true],
            ...
            'App\\Form\\JourType' => ['privates', 'App\\Form\\JourType', 'getJourTypeService', true],
            'App\\Form\\ProduitType' => ['privates', 'App\\Form\\ProduitType', 'getProduitTypeService', true],
            'App\\Form\\ReserverBilletType' => ['privates', 'App\\Form\\ReserverBilletType', 'getReserverBilletTypeService', true],
            ...
            'App\\Form\\ClientType' => '?',
            'App\\Form\\DinosaureType' => '?',
            'App\\Form\\EnclosType' => '?',
            'App\\Form\\FormatBilletType' => '?',
            'App\\Form\\FormatChambreType' => '?',
            'App\\Form\\HoraireType' => '?',
            'App\\Form\\HotelType' => '?',
            'App\\Form\\JourType' => '?',
            'App\\Form\\ProduitType' => '?',
            'App\\Form\\ReserverBilletType' => '?',
