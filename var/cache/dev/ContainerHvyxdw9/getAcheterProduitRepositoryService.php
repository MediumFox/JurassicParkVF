 ...
 */
class getAcheterProduitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcheterProduitRepository' shared autowired service.
     *
     * @return \App\Repository\AcheterProduitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcheterProduitRepository.php';

        return $container->privates['App\\Repository\\AcheterProduitRepository'] = new \App\Repository\AcheterProduitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
