 ...
 */
class getFormatBilletRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FormatBilletRepository' shared autowired service.
     *
     * @return \App\Repository\FormatBilletRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FormatBilletRepository.php';

        return $container->privates['App\\Repository\\FormatBilletRepository'] = new \App\Repository\FormatBilletRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
