 ...
 */
class getRemboursementHotelRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RemboursementHotelRepository' shared autowired service.
     *
     * @return \App\Repository\RemboursementHotelRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RemboursementHotelRepository.php';

        return $container->privates['App\\Repository\\RemboursementHotelRepository'] = new \App\Repository\RemboursementHotelRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
