...
class __TwigTemplate_a90e1d157aeac4aee3401c25e438cdb0 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    ";
        yield from $this->loadTemplate("reuse/hero.html.twig", "hotel/index.html.twig", 6)->unwrap()->yield($context);
        // line 7
        yield "    <div class=\"flex justify-around p-5 gap-10\">
        <div class=\"w-[30%]\">
            ";
        // line 9
        yield from $this->loadTemplate("reuse/dashboard-admin.html.twig", "hotel/index.html.twig", 9)->unwrap()->yield($context);
        // line 10
        yield "        </div>
        <div class=\"w-[70%] mx-auto p-2\">
            ...
            <div class=\"grid-cols-4 grid-rows-4 grid gap-7\" id=\"hotelContainer\">
                ";
        // line 21
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["hotels"]) || array_key_exists("hotels", $context) ? $context["hotels"] : (function () { throw new RuntimeError('Variable "hotels" does not exist.', 21, $this->source); })()))) {
            // line 22
            yield "                    ";
            yield from $this->loadTemplate("hotel/_hotel_cards.html.twig", "hotel/index.html.twig", 22)->unwrap()->yield($context);
            // line 23
            yield "                ";
        } else {
            // line 24
            yield "                    <span>Aucun hôtel trouvé</span>
                ";
        }
        // line 26
        yield "            </div>
...
";
        // line 30
        yield from $this->loadTemplate("reuse/display/addDisplay.html.twig", "hotel/index.html.twig", 30)->unwrap()->yield($context);
        // line 31
        yield from $this->loadTemplate("reuse/display/updateDisplay.html.twig", "hotel/index.html.twig", 31)->unwrap()->yield($context);
        // line 32
        yield "    <script>
        function filterName() {
            ...
            const url = \"";
        // line 36
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_hotel_filter_name");
...
{% endblock %}
", "hotel/index.html.twig", "C:\\laragon\\www\\JurassicPark\\templates\\hotel\\index.html.twig");
    }
}
