...
/* user/home.html.twig */
class __TwigTemplate_a01350a7d02ee6025cfa4028240376d7 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <div class=\"flex justify-end flex-col items-center h-[95vh] relative bg-cover bg-center\" style=\"background-image: url('";
        ...
        <div class=\"relative top-[15%] text-gris text-center z-20 flex flex-col items-center space-y-4 px-4\">
        ...
        <svg class=\"z-20\" viewBox=\"0 0 1440 320\">
    ...
    ";
        // line 41
        yield from $this->loadTemplate("apiComponents/weatherContainer.html.twig", "user/home.html.twig", 41)->unwrap()->yield($context);
        // line 42
        yield "
    <script>
        let count = 2345678;
...
";
    ...
    {
        return array (  141 => 42,  139 => 41,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <div class=\"flex justify-end flex-col items-center h-[95vh] relative bg-cover bg-center\" style=\"background-image: url('{{ asset('img/test.jpg') }}');\">
        <div class=\"absolute inset-0 z-10\" style=\"background-color: rgba(0, 0, 0, 0.5);\"></div>
