...
class __TwigTemplate_22fc86b9758b9a62090e248e9c00dfc8 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    ";
        yield from $this->loadTemplate("reuse/hero.html.twig", "chambre/index.html.twig", 6)->unwrap()->yield($context);
        // line 7
        yield "    <div class=\"flex justify-around p-5 gap-10\">
        <div class=\"w-[30%]\">
            ";
        // line 9
        yield from $this->loadTemplate("reuse/dashboard-admin.html.twig", "chambre/index.html.twig", 9)->unwrap()->yield($context);
        // line 10
        yield "        </div>
        <div class=\"w-[70%] mx-auto p-2\">
            ...
            <div class=\"grid-cols-4 grid-rows-4 grid gap-7 overflow-hidden\"  id=\"chambreContainer\">
                ";
        // line 21
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["chambres"]) || array_key_exists("chambres", $context) ? $context["chambres"] : (function () { throw new RuntimeError('Variable "chambres" does not exist.', 21, $this->source); })()))) {
            // line 22
            yield "                    ";
            yield from $this->loadTemplate("chambre/_chambre_cards.html.twig", "chambre/index.html.twig", 22)->unwrap()->yield($context);
            // line 23
            yield "                ";
        } else {
            // line 24
            yield "                    <span>Aucune chambre trouvé</span>
                ";
        }
        // line 26
        yield "            </div>
    ...
    ";
        // line 29
        yield from $this->loadTemplate("reuse/display/addDisplay.html.twig", "chambre/index.html.twig", 29)->unwrap()->yield($context);
        // line 30
        yield "    ";
        yield from $this->loadTemplate("reuse/display/updateDisplay.html.twig", "chambre/index.html.twig", 30)->unwrap()->yield($context);
        // line 31
        yield "
    <script>
        function filterName() {
            ...
            const url = \"";
        // line 36
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_chambre_filter_name");
...
{% endblock %}
", "chambre/index.html.twig", "C:\\laragon\\www\\JurassicPark\\templates\\chambre\\index.html.twig");
    }
}
