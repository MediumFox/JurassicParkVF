...
class __TwigTemplate_f835f5457d873a4aa70700aa9d4d8859 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    ";
        yield from $this->loadTemplate("reuse/hero.html.twig", "produit/index.html.twig", 6)->unwrap()->yield($context);
        // line 7
        yield "    <div class=\"flex justify-around p-5 gap-10\">
        <div class=\"w-[30%]\">
            ";
        // line 9
        yield from $this->loadTemplate("reuse/dashboard-admin.html.twig", "produit/index.html.twig", 9)->unwrap()->yield($context);
        // line 10
        yield "        </div>
        <div class=\"w-[70%] mx-auto p-2\">
            ...
            <div class=\"grid-cols-4 grid-rows-4 grid gap-7\" id=\"produitContainer\">
                ";
        // line 21
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["produits"]) || array_key_exists("produits", $context) ? $context["produits"] : (function () { throw new RuntimeError('Variable "produits" does not exist.', 21, $this->source); })()))) {
            // line 22
            yield "                    ";
            yield from $this->loadTemplate("produit/_produit_cards.html.twig", "produit/index.html.twig", 22)->unwrap()->yield($context);
            // line 23
            yield "                ";
        } else {
            // line 24
            yield "                    <span>Aucun produit trouvé</span>
                ";
        }
        // line 26
        yield "            </div>
...
";
        // line 31
        yield from $this->loadTemplate("reuse/display/addDisplay.html.twig", "produit/index.html.twig", 31)->unwrap()->yield($context);
        // line 32
        yield from $this->loadTemplate("reuse/display/updateDisplay.html.twig", "produit/index.html.twig", 32)->unwrap()->yield($context);
        // line 33
        yield "
    <script>
        function filterName() {
            ...
            const url = \"";
        // line 38
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_produit_filter_name");
...
";
    ...
    {
        return array (  152 => 38,  145 => 33,  143 => 32,  141 => 31,  134 => 26,  130 => 24,  127 => 23,  124 => 22,  122 => 21,  109 => 10,  107 => 9,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "produit/index.html.twig", "C:\\laragon\\www\\JurassicPark\\templates\\produit\\index.html.twig");
    }
}
