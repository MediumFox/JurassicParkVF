 ...
 */
class getOuvertureRestaurantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OuvertureRestaurantRepository' shared autowired service.
     *
     * @return \App\Repository\OuvertureRestaurantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OuvertureRestaurantRepository.php';

        return $container->privates['App\\Repository\\OuvertureRestaurantRepository'] = new \App\Repository\OuvertureRestaurantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
