 ...
 */
class getLouerHotelRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LouerHotelRepository' shared autowired service.
     *
     * @return \App\Repository\LouerHotelRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LouerHotelRepository.php';

        return $container->privates['App\\Repository\\LouerHotelRepository'] = new \App\Repository\LouerHotelRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
