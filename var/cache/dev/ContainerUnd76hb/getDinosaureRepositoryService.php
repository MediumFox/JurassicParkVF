 ...
 */
class getDinosaureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DinosaureRepository' shared autowired service.
     *
     * @return \App\Repository\DinosaureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DinosaureRepository.php';

        return $container->privates['App\\Repository\\DinosaureRepository'] = new \App\Repository\DinosaureRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
