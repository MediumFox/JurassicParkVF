 ...
 */
class getReserverRestaurantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReserverRestaurantRepository' shared autowired service.
     *
     * @return \App\Repository\ReserverRestaurantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReserverRestaurantRepository.php';

        return $container->privates['App\\Repository\\ReserverRestaurantRepository'] = new \App\Repository\ReserverRestaurantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
