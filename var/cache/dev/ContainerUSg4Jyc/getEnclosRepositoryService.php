 ...
 */
class getEnclosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EnclosRepository' shared autowired service.
     *
     * @return \App\Repository\EnclosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnclosRepository.php';

        return $container->privates['App\\Repository\\EnclosRepository'] = new \App\Repository\EnclosRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
