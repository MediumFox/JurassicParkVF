 ...
 */
class getRemboursementBilletRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RemboursementBilletRepository' shared autowired service.
     *
     * @return \App\Repository\RemboursementBilletRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RemboursementBilletRepository.php';

        return $container->privates['App\\Repository\\RemboursementBilletRepository'] = new \App\Repository\RemboursementBilletRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
