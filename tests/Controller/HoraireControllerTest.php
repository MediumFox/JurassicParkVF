...
final class HoraireControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'horaire[ouverture]' => 'Testing',
            'horaire[fermeture]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        $this->markTestIncomplete();
        $fixture = new Horaire();
        $fixture->setOuverture('My Title');
        $fixture->setFermeture('My Title');
    ...
    public function testEdit(): void
    {
        $this->markTestIncomplete();
        $fixture = new Horaire();
        $fixture->setOuverture('Value');
        $fixture->setFermeture('Value');
        ...
        $this->client->submitForm('Update', [
            'horaire[ouverture]' => 'Something New',
            'horaire[fermeture]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getOuverture());
        self::assertSame('Something New', $fixture[0]->getFermeture());
    }
